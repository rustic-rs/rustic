...
| log-file          | Path to the log file.                                 | "/log/rustic.log" |
...
| Attribute         | Description                                            | Default Value  |
|-------------------|--------------------------------------------------------|----------------|
| repository        | The path to the repository. Required.                 | "/tmp/rustic"  |
| repo-hot          | The path to the hot repository.                       | Not set        |
| password          | The password for the repository.                      | "mySecretPassword" |
...
| cache-dir         | Path to the cache directory.                          | Default cache dir, e.g., ~/.cache/rustic |
...
| Attribute             | Description                                            | Default Value  |
|-----------------------|--------------------------------------------------------|----------------|
| post-create-command   | Command to execute after creating a snapshot in the local backend. | "par2create -qq -n1 -r5 %file" |
| post-delete-command   | Command to execute after deleting a snapshot in the local backend. | "sh -c \"rm -f %file*.par2\"" |

### Snapshot-Filter Options

| Attribute         | Description                                            | Default Value  |
|-------------------|--------------------------------------------------------|----------------|
| filter-host       | Array of hosts to filter snapshots.                   | ["myhost"]     |
...
| Attribute              | Description                                            | Default Value  |
|------------------------|--------------------------------------------------------|----------------|
| filter-host            | Array of hosts to filter snapshots.                   | ["forgethost"] |
...
| keep-within-daily      | The time duration within which daily backups will be kept. | "7 days"     |
| keep-tags              | Array of tags to keep.                                | ["mytag"]      |
...
| cache-dir              | Path to the cache directory for the target repository. | Default cache dir, e.g., ~/.cache/rustic |
